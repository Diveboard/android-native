...
public class					NewTanksDialogFragment extends DialogFragment
{
	...
	private int						mTextSize = 20;
	 ...
	 private void				openTanksEdit(final Integer index)
	 {
		 ...
		 DiveboardSpinnerAdapter cylinderAdapter = new DiveboardSpinnerAdapter(getActivity().getApplicationContext(), R.layout.units_spinner);
		 if(tank.getMultitank() != null && tank.getMultitank() == 2){
...
//		 cylinderAdapter.setTextSize(40);
